...
\title{Title here} % Poster title

\author{Jianbo Chen, Billy Fang, Cheng Ju} % Author(s)

\institute{CS 294-129, Fall 2016} % Institution(s)
...
\begin{figure}
Hi%\includegraphics[width=0.8\linewidth]{1.jpg}
