...
%	INTRODUCTION
%----------------------------------------------------------------------------------------
\headerbox{Variational auto-encoder (VAE)}{name=VAE,column=0,below=Background}{
\begin{itemize}\compresslist
...
\begin{minipage}[b]{\textwidth}
\center
\includegraphics[width=0.9\textwidth]{images/cvae.png}
\centering
\end{minipage}
\begin{scriptsize}
\begin{equation}
...
\includegraphics[width=0.9\textwidth]{images/draw_model.png}
\centering

\includegraphics[width=0.8\textwidth]{images/cdraw.png}
\centering
\end{minipage}
}
