...
{
\bf
\textsc{Variational Auto-encoders...?}
\vspace{0.5em}
} % Poster title
...
%	INTRODUCTION
%----------------------------------------------------------------------------------------
\headerbox{VAE}{name=VAE,column=0,below=Background}{
\begin{minipage}[b]{0.9\textwidth}
\center
\includegraphics[width=0.45\textwidth]{images/graphical_model.png}
\includegraphics[width=0.45\textwidth]{images/vae.png}
\end{minipage}
\begin{equation}
\log p(x)
...
\headerbox{CVAE}{name=CVAE,column=0,below=VAE}{
\begin{minipage}[b]{0.9\textwidth}
\center
\includegraphics[width=\textwidth]{images/cvae.png}
\end{minipage}
\begin{scriptsize}
\begin{equation}
\log p(x \mid y)
...
\begin{minipage}[b]{0.9\textwidth}
\center
\includegraphics[width=0.6\textwidth]{images/svhn_left_half.png}
%\includegraphics[width=0.6\textwidth]{images/svhn_cvae_fc_style.png}
\end{minipage}
}
...
\headerbox{Semi-supervised learning}{name=ssl,column=1}{
\begin{itemize}\compresslist
...
\headerbox{Adding GANs}{name=gan,column=1,below=ssl}{ % This block is as tall as the references
\begin{itemize}\compresslist
...
\begin{minipage}[b]{0.9\textwidth}
\includegraphics[width=\textwidth]{images/vaegan.png}
\end{minipage}

Replace decoder loss with comparison of discriminator layers

\begin{minipage}[b]{0.9\textwidth}
\includegraphics[width=\textwidth]{images/vaegan2.png}
\end{minipage}
}


\headerbox{CVAEGAN}{name=cvaegan,column=1,below=gan}{
...
\headerbox{Deep feature loss}{name=deep_feature,row=0,column = 2}{
a
}



\headerbox{Future Directions}{name=future,column=2,span=1,below = deep_feature}{ % This block is as tall as the references block
a
%\vspace{0.3em}
 }
...
\bibliography{../final_report/cs294_bib}
\nocite{kingma2013auto,doersch2016tutorial,larsen2015autoencoding,hou2016deep}
}
