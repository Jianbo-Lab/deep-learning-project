...
Conditional DRAW is an extension of vanilla DRAW. The input of the encoder and decoder of conditional DRAW is the same as vanilla DRAW, except the additional information (e.g. the label of the image).
