...
\headerbox{Variational auto-encoder}{name=VAE,column=0,below=Data}{
\begin{itemize}\compresslist
...
\begin{itemize}\compresslist 
    ...
    $$
    L = L_{\textit{KL}} + L_{\textit{REC}} + L_{\textit{GAN}}, 
    $$
    where 
    $$
    L_{\textit{KL}} =  KL(p_z(z),q(z|x)); L_{\textit{REC}} =  \mathbb{E}_{q(Z|X)}[p(\textit{Dis}_l(X)|Z)]   ;L_{\textit{GAN}} = \mathbb{E}_{z\tilde p_z(z)}[\log  D(G(z))].  
    $$
...
\end{minipage}
\begin{minipage}[b]{\textwidth}
\includegraphics[width=0.8\textwidth]{images/vaegan_images.png}
\centering
\end{minipage}
...
\headerbox{CVAE with CGAN}{name=cvaegan,column=2,row=0}{
\begin{itemize}\compresslist 
...
%\end{minipage}
\begin{minipage}[b]{\textwidth}
\includegraphics[width=0.8\textwidth]{images/cvaegan_images1.png}
\centering
\end{minipage}
\begin{minipage}[b]{\textwidth}
\includegraphics[width=0.8\textwidth]{images/cvaegan_images2.png}
\centering
\end{minipage}
}
...
\begin{itemize}\compresslist 
 ...
 \item Both the discriminator of CGAN and the encoder of SSL VAE can be used as a classifier. 
...
\headerbox{DRAW}{name=DRAW,column = 2, below=cvaegan}{
\begin{itemize}\compresslist
\item attention-based sequential generation
\item RNN structure
\item Generalization 1: Condition DRAW on labels.
