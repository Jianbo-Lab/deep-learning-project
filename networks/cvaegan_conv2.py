...
class Encoder:
    ...
    def __call__(self, x, y, z_dim, batch_size=100, x_width=28,train_phase = True):
        """
        ...
        net = slim.conv2d(net, 28, [5,5], stride=2,
            normalizer_fn=slim.batch_norm,
            normalizer_params={'is_training':train_phase,
                'scale':True,
                'updates_collections':None,
                'scope':'enc_bn0'}) 
        net = slim.conv2d(net, 56, [5,5], stride=2,
            normalizer_fn=slim.batch_norm,
            normalizer_params={'is_training':train_phase,
                'scale':True,
                'updates_collections':None,
                'scope':'enc_bn1'}) 
        net = slim.conv2d(net, 108, [5,5], stride=2,
            normalizer_fn=slim.batch_norm,
            normalizer_params={'is_training':train_phase,
                'scale':True,
                'updates_collections':None,
